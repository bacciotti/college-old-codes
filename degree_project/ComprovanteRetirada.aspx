<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ComprovanteRetirada.aspx.vb" Inherits="MsgCadastroSucesso" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Label ID="lblTituloPagina" runat="server" Font-Bold="True" Font-Names="Calibri" 
    Font-Size="X-Large" Text="A retirada de sangue foi realizada com sucesso!" 
...
&nbsp;<asp:Label ID="lblTipoSangue" runat="server" Font-Names="Calibri" 
    ...
    <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Calibri" 
        Text="Nome do receptor:"></asp:Label>
