...
<?php
$email = $_GET['email'];
mail($email, "UNIDOS - Projeto Universitario de Doacao de Sangue", "Ola! Quem lhe escreve é um
...
//pelo metodo MAIL, um email eh enviado ao usuario cadastrado. ( o email é enviado somente se o software estiver em servidor web)
?>
